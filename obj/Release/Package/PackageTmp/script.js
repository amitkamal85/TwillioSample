$(document).ready(function () {
    if ($('#isDone').attr("Value") == "true") {
        alert('Call forwarding is enabled now!')
    }
    if ($('#isDone').attr("Value") == "false") {
        alert('Call forwarding is disable now!')
    }
...
$(document).ready(function () {
    ...
    var controlButton = $('#btnStartCall');
    ...
    controlButton.click(function (e) {
        ...
        if ($('#rdb_start').is(":checked")) {
            
            alert('Call forwarding is already enabled!');
            return false;
        }
        else {
            alert('Call forwarding will be enabled in 30 seconds!');
        }
        //if ($('#isDone').attr("Value") == "true") {
        //    alert('Call forwarding is enabled now ');
        //}
    ...
    $('#btnEndCall').click(function () {
        if ($('#rdb_end').is(":checked")) {
            alert('Call forwarding already disabled!');
            return false;
    ...
    $.fn.progressInitialize = function () {
        ...
        return this.each(function () {
            ...
            var options = $.extend({
                ...
                loading: 'Your call will start in 30 seconds',
                finished: 'Done!'
            }, button.data());
